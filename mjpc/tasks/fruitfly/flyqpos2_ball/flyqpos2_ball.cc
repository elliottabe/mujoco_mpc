...
const std::array<std::string, 42> joint_names = {
    "coxa_flexion_T1_left",  "coxa_twist_T1_left",  "coxa_T1_left",  "femur_T1_left",  "femur_twist_T1_left",  "tibia_T1_left",  "tarsus_T1_left", 
    "coxa_flexion_T1_right", "coxa_twist_T1_right", "coxa_T1_right", "femur_T1_right", "femur_twist_T1_right", "tibia_T1_right", "tarsus_T1_right", 
    "coxa_flexion_T2_left",  "coxa_twist_T2_left",  "coxa_T2_left",  "femur_T2_left",  "femur_twist_T2_left",  "tibia_T2_left",  "tarsus_T2_left", 
    "coxa_flexion_T2_right", "coxa_twist_T2_right", "coxa_T2_right", "femur_T2_right", "femur_twist_T2_right", "tibia_T2_right", "tarsus_T2_right",
    "coxa_flexion_T3_left",  "coxa_twist_T3_left",  "coxa_T3_left",  "femur_T3_left",  "femur_twist_T3_left",  "tibia_T3_left",  "tarsus_T3_left", 
    "coxa_flexion_T3_right", "coxa_twist_T3_right", "coxa_T3_right", "femur_T3_right", "femur_twist_T3_right", "tibia_T3_right", "tarsus_T3_right"};
}  // namespace

namespace mjpc::fruitfly {

std::string FlyQpos2_ball::XmlPath() const {
  return GetModelPath("fruitfly/flyqpos2_ball/task.xml");
}
std::string FlyQpos2_ball::Name() const { return "Fruitfly Qpos2 ball"; }
...
// ----------------------------------------------------------------
void FlyQpos2_ball::ResidualFn::Residual(const mjModel *model, const mjData *data,
...
// ----------------------------------------------------------------------------
void FlyQpos2_ball::TransitionLocked(mjModel *model, mjData *d) {
  // get motion start index
...
void FlyQpos2_ball::ResetLocked(const mjModel* model) {
  // ----------  task identifiers  ----------
