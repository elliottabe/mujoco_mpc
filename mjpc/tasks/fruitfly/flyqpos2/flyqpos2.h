...
#ifndef MJPC_TASKS_FRUITFLY_QPOS2_TASK_H_
#define MJPC_TASKS_FRUITFLY_QPOS2_TASK_H_
...
class FlyQpos2 : public Task {
 public:
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    explicit ResidualFn(const FlyQpos2* task, int current_mode = 0,
